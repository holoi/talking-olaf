...
public class AzureTTSForGpt : MonoBehaviour
{
    ...
    private const string SubscriptionKey = "96b9276e8f344a3e9f0071c099f5055a";
    ...
    public async void StartTTS()
    {
        ...
        using (var result = await synthesizer.StartSpeakingTextAsync(inputText))
        {
    ...
    void Start()
    {
        //LeftTimeAnimator.enabled = false;
